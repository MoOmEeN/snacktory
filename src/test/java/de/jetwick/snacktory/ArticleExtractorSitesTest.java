...
public class ArticleExtractorSitesTest {
  ...
  public ArticleExtractorSitesTest(String testName, Expectations expectations){
  ...
  private static Expectations expectCorrectText(){
